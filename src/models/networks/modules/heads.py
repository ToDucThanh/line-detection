...
class LineHead(ModuleBase):
    def __init__(self, input_channels, m, output_channels):
        ...
        self.branch1 = nn.Sequential(
            ...
            nn.Conv2d(
                m, output_channels, kernel_size=(1, ks), padding=(0, int(ks / 2))
            ),
        )
        ...
        self.branch3 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(
                m, output_channels, kernel_size=(ks, 1), padding=(int(ks / 2), 0)
            ),
        )
...
class MultitaskHead(ModuleBase):
